...
export default function RiskOracleLayerPage() {
  return (
    <article className="mx-auto w-full max-w-4xl">
      ...
      <div className="mt-6 rounded-2xl border border-skyglass-deep/25 bg-skyglass-mist/80 p-5">
        <p className="text-sm leading-6 text-skyglass-muted">
          The{" "}
          <Link href="/monitor" className="font-semibold text-navy-700 hover:text-navy-600">
            live monitor
          </Link>{" "}
          reads the same JSON contract the operator dashboard uses: stress score,
          liquidity health, depeg probability, protection mode, active protections,
          and secondary signals (velocity, imbalance, whale exits, oracle divergence,
          bridge outflows).
        </p>
      </div>
