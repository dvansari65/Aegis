...
function XIcon({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M18.244 2H21l-6.522 7.45L22 22h-6.789l-4.74-6.198L4.998 22H2.241l6.984-7.978L2 2h6.957l4.286 5.668L18.244 2zm-1.19 18.385h1.5L7.06 3.534h-1.6l11.594 16.85z" />
    </svg>
  );
}
...
const cols = [
  {
    title: "Protocol",
    links: ["Architecture", "Risk Oracle", "Circuit Breakers", "Audits"],
  },
  {
    title: "Developers",
    links: ["Documentation", "SDK", "Integrations", "API Reference"],
  },
  {
    title: "Company",
      ...
      <div className="container-x">
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-4 border-t border-skyglass-deep/20 pt-6 md:flex-row md:items-center">
          ...
          <div className="flex items-center gap-5 text-[12px] text-skyglass-muted">
            <a href="#" className="transition-colors hover:text-skyglass-ink">
              Privacy
            </a>
